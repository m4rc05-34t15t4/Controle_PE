<?php
    ...
    include_once $link."conexao.php";

    include_once $link."funcoes.php";
    ...
    if($query) {
        ...
        //Define MI BASE:
        //1365-4-NO", L9, C26 25K
        Define_mi_central("1365-4-NO", 9, 26);
    ...
    function Cria_sql($mi_start = 0){
        ...
        return "SELECT " . $campos . " FROM \"public\".\"" . $NOME_BD . "\" WHERE " . $filtro_or . "length(mi) >= 9 ORDER BY \"mi\"";// AND \"regiao\" = 'Litoral'
    }
    ...
    function Gerar_sql_update_tabela_mi_ligacao(){
        ...
        for($s=0; $s < count($lista_final_mi); $s++){
            $sql .= "UPDATE \"public\".\"" . $NOME_BD . "\" SET \"linha\" = " . $lista_final_mi[$row[$s]["mi"]]["linha"] . 

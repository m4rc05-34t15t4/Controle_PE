...
<?php
    ...
    function Criar_tabela_todos_blocos(){
        ...
        $sql = "SELECT mi, linha, coluna, regiao, bloco FROM \"public\".\"" . $NOME_BD . "\" ORDER BY linha, coluna, mi";
    ...
    function Criar_css_posicao_div_blocos(){
        ...
        $sql = "SELECT 
            TRUNC(AVG(linha), 0) AS linha_media, 
            TRUNC(AVG(coluna), 0) AS coluna_media, bloco 
            FROM \"public\".\"" . $NOME_BD . "\" as ligacao 
            GROUP BY bloco
            ORDER BY bloco;";
